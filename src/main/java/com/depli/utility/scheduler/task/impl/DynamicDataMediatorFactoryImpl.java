...
import com.depli.utility.mediator.*;
 ...
 * Scheduler Factory
 *
 * Interface for the component which includes the Async methods to refresh dynamic descriptor data in caches periodically.
 *
 * @author lpsandaruwan
 * @since 9/17/17
 */
...
public class DynamicDataMediatorFactoryImpl implements DynamicDataMediatorFactory {
    ...
    public void mediate(Long nodeId) {
        ...
        platformResourcesMXBeanMediator.mediateDynamicData(nodeId, connectionTree.getPlatformResourcesMXBean());
