 ...
 *
 * Provides methods for proxy connection initiation for remote class loading management extension
 * bean.
 *
 * @author lpsandaruwan
 * @since 9/17/17
...
public interface ClassLoadingMXBeanProxyConnector {
  ...
  /**
   * Returns class loading management extension bean for appropriate management bean server
   * connection.
   *
