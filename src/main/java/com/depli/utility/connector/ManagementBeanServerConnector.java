 ...
 *
 * Provides methods to open and retrieve management bean server connection for given remote Java
 * virtual machine.
 *
 * @author lpsandaruwan
 * @since 9/17/17
...
public interface ManagementBeanServerConnector {
  ...
  /**
   * Returns main connector object containing management bean server connection for given remote
   * Java virtual machine node information.
   *
