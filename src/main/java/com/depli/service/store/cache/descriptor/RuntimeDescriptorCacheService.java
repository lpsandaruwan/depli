...
public interface RuntimeDescriptorCacheService {
  ...
  /**
   * Returns infinispan cache which uses to store and retrieve Runtime descriptors mapped by the
   * Long values, node IDs related to remote JMX connections which are generated by hibernate.
   *
