...
public interface ConnectionTreeService {
    ...
    /**
     * Retrieves connection tree object from connection tree object cache using Long value, nodeId which is generated
     * by application when persisting JMX remote connection node's metadata.
     *
