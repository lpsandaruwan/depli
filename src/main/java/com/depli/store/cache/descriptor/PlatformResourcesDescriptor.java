...
public class PlatformResourcesDescriptor {
  ...
  /**
   * Returns free amount of physical system memory of the host machine where Java virtual machine
   * runs.
   *
  ...
  /**
   * Returns total amount of physical system memory of the host machine where Java virtual machine
   * runs.
   *
  ...
  /**
   * Sets total amount of physical system memory of the host machine where Java virtual machine
   * runs.
   *
